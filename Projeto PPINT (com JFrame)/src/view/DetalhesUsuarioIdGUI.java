...
public class DetalhesUsuarioIdGUI extends JFrame implements ActionListener
{
	...
	public DetalhesUsuarioIdGUI(int indice) 
	{
		...
		bRemover = new JButton(bn.getString("Controle.Funcionario.Detalhes"));
	...
	public void actionPerformed(ActionEvent event) 
	{
		...
		{  
			...
			try
			{
				...
				{    
					dispose();
					new DetalhesUsuarioGUI(getIndice(),getId());
				}    
				else{
					tID.setText("");
