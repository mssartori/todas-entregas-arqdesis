	...
	<div id="main" class="container">
		...
		<div class="alert alert-danger" role="alert">
			<h2 class="text-center">
				<span class="glyphicon glyphiconexclamation-
sign"
					aria-hidden="true"></span> <span class="sr-only">Erro:</span>
				Aconteceu um erro.
			</h2>
		</div>
		<p class="lead text-danger bg-danger textjustify">
			< strong>Causa:</strong> ${pageContext.errorData.throwable.message}
		</p>
		<p class="text-danger bg-danger text-justify">
			<strong>Pilha de Execução:</strong><br>
			<c:forEach var="trace"
