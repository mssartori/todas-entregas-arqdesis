...
package com.example.mssar.arqdsis.util;
...
public class Utils {
    ...
    private static com.example.mssar.arqdsis.util.StatusTracker mStatusTracker = com.example.mssar.arqdsis.util.StatusTracker.getInstance();
